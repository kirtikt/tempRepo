		...
		<td width="20%" valign="top">
			...
			<table id='flexme1' border="1"  width=100%>
							...
							List<Clientmanager> cltList=manager.getList();
								...
								boolean flag = false;
								int count = 0;
								out.print("<tr><td><b>Client id</b></td><td><b>Available Credits</b><td><b>Sending Interface</b></td><td><b>operation</b></td><tr>");
								while (it.hasNext()) {
									count++;
									...
									out.print("<tr><td>"
											...
											+"</td><td><a href='/payless4sms/admin/changepassword.jsp?pKeyManager="+sr.getPkclientmanagerid()+"'>Change password</a>  |<a href='/payless4sms/admin/addcredit.jsp?pKeyManager="+sr.getPkclientmanagerid()+"'>Add Credits</a>  |  <a href='/payless4sms/admin/editclient.jsp?pKeyManager="+sr.getPkclientmanagerid()+"'>Edit</a> | <a href='/payless4sms/DeleteClient?pKeyManager="+sr.getPkclientmanagerid()+"'>Delete</a></td></tr>");
								}
