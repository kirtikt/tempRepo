		...
		<tr>
			...
			<td valign="top">
				...
				<form action="/payless4sms/WriteTOExcel" method="post"
					id="formid">
					<input type="hidden" name="reportType" value="failedreportforadmin"/>
			...
			boolean flag = false;
			out.print("<tr><th>UserId</th><th>destination</th><th>source</th><th>Reason</th><th>Timedate</th><th>SmsId</th><th>Message</th><tr>");
			while (it.hasNext()) {
				Sms sms = (Sms) it.next();
				...
				out.print("<tr><td>"+ sms.getClientmanager().getSysuser().getUserid() + "</td><td>" 
						...
						+ "</td><td>" +sms.getStatus()+ "</td><td>" +new Helper().myTimeIn(sms.getDatetime())
