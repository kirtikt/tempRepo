				...
				<div id="login-content">
					<h3 class="heading_text">SMSC</h3>
						...
						<table id='flexme1' style="width:1000px">
							...
							{
						        	int count=1;
						        	out.print("<tr><td>No.</td><td> SMSC Proxy name </td><td></td><td></td></tr>");
								for(Iterator<Smscproxy> it1=mnolist.iterator();it1.hasNext();)
								{
									
									out.print("<tr>");
									Smscproxy smsc= (Smscproxy)it1.next();
								    out.print("<td>"+ count +"</td>");
								    out.print("<td>"+smsc.getName()+"</td>");
								    out.print(" <td> <a href='/payless4sms/admin/editsmscproperty.jsp?smscid="+smsc.getPksmscproxyid()+"'> edit </a></td> ");
								    out.print(" <td> <a href='/payless4sms/admin/deletesmsc.jsp?smscid="+smsc.getPksmscproxyid()+"'> delete </a> </td>");
									out.print("</tr>");
									count++;
								}
							}
