package com.ecomm.ultimatesms.messaging.client.settings;
 ...
 */
public class DeleteFutureSms extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteFutureSms() {
        super();
	...
	public void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException  {
		...
		Logger log=LoggerFactory.getLogger(DeleteFutureSms.class);
		...
		RequestDispatcher rd = request
				.getRequestDispatcher("sms/removefuturesms.jsp");
