	...
	<table border="1px" cellpadding="0" cellspacing="0" width="100%">
		...
		<td width="20%" valign="top">
			...
			<td valign="top">
				<form action="/payless4sms/ReportByCellNumber" method="post" >
					...
					<table>
						...
						%>
							...
							<input type="hidden" name="type" value="sysadmin" >
							</td>
						</tr> 
						<tr>
				...
				List<Sms> smsList= new SmsManager().getReportByCellNumber(fixDestination , from, to );
				if(smsList!=null && smsList.size()!=0){
				out.print("<tr><th>User</th><th>destination</th><th>Timedate</th><th>status</th><tr>");
				Iterator<Sms> it=smsList.iterator();
				Helper hp=new Helper();
				while(it.hasNext())	{
					Sms sms=(Sms)it.next();
					String st=hp.getSmsStatus(sms.getSmsid(),"a");
					out.print("<tr><td>"+sms.getClientmanager().getSysuser().getUserid()+"</td><td>"+sms.getDestination()+"</td><td>"+new Helper().myTimeIn(sms.getDatetime())+"</td><td><font color='#5DAC0E'>"+st+"</font></td><tr>");
				}	
