				...
				<div id="login-content">
					<h3 class="heading_text">SMSC</h3>
						...
						<table id='flexme1' style="width:1000px">
							...
							SmscproxypropertyManager mnom=new SmscproxypropertyManager();
							List mnolist=mnom.getList();      
						        if(mnolist!=null || mnolist.size()!=0)
							{
						        	int count=1;
						        	out.print("<tr><td>No.</td><td> SMSC Proxy interface name </td><td></td><td></td></tr>");
								for(Iterator<Smscproxyproperty> it1=mnolist.iterator();it1.hasNext();)
								{
									
									out.print("<tr>");
									Smscproxyproperty smsc= (Smscproxyproperty)it1.next();
								    out.print("<td>"+ count +"</td>");
								    out.print("<td>"+smsc.getName()+"</td>");
								    out.print(" <td> <a href='/payless4sms/admin/editinterfacesmsc.jsp?smscinterfaceid="+smsc.getPksmscpropid()+"'> edit </a></td> ");
								    out.print(" <td> <a href='/payless4sms/admin/deletesmscinterface.jsp?smscinterfaceid="+smsc.getPksmscpropid()+"'> delete </a> </td>");
									out.print("</tr>");
									count++;
								}
							}
