...
var ck_validchar = /^[\040-\177]*$/;
	...
	function validateThis(dataform) {
		...
		if(validContact(dataform.receiver.value) && validMessage(dataform.message.value)&& validReply(dataform.replies.checked,dataform.sender.value) && validMessageLength(dataform.message.value))
			return true;
		else
			return false;
...
<body>
	...
	<table border="1px" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<h3>Fast SMS (Comma seperated) eg: 0277777777,333333333</h3>
				<form action="/payless4sms/SendSingleMessage" method="post" id="formid" onSubmit="return validateThis(this)">
					...
					<% if(request.getAttribute("successmessage")!=null){
						...
						<tr>
							...
							<td><small>eg: 0277777777,333333333</small><br><textarea id="receiver" cols="16" rows="10"
