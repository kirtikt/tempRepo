				...
				<div id="login-content">
					<h3 class="heading_text">Mno</h3>
						...
						<table id='flexme1' style="width:1000px">
							...
							{
						        	int count=1;
						        	out.print("<tr><td>No.</td><td> MNO name </td><td></td><td></td></tr>");
								for(Iterator<Mno> it1=mnolist.iterator();it1.hasNext();)
								{
								    ...
								    out.print(" <td> <a href='/payless4sms/admin/editmno.jsp?mnoid="+mno.getPkmnoid()+"'> edit </a></td> ");
								    out.print(" <td> <a href='/payless4sms/admin/deletemno.jsp?mnoid="+mno.getPkmnoid()+"'> delete </a> </td>");
									out.print("</tr>");
									count++;
								}
							}
