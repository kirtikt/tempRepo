...
function requiredFiled(){
	if(document.getElementById("userid").value=="" || document.getElementById("password").value=="" || document.getElementById("repassword").value=="" || document.getElementById("clientref").value=="" || document.getElementById("smscost").value=="" || document.getElementById("replycost").value==""){
		...
		<tr>
			...
			<td valign="top">
				...
				<div id="login-content">
					...
					<form action="/payless4sms/EditUser" id="form" method="post" onsubmit="return requiredFiled();">
					
						<%
						ClientmanagersManager manager = new ClientmanagersManager();
						Long pkerManager=null;
						
						if(request.getParameter("pKeyManager")!=null)
						 	pkerManager=Long.parseLong(request.getParameter("pKeyManager"));
						 ...
						 <div id="err" style="color: rgb(206, 57, 57);">
							...
							<tr>
								...
								<input type="text" id="userid"
									name="userid" value="<%=cm.getSysuser().getUserid()%>" class="required"/></td>
							</tr>
							
							<tr>
								<td>ClientRef</td>
								<td><input type="text" name="clientref" id="clientref" class="required"  value="<%=cm.getSysuser().getClientref()%>" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td>SMS Cost</td>
								<td><input type="text" name="smscost" id="smscost" class="input required"  value="<%=cm.getLocalsmscost()%>" /></td>
							</tr>
							<tr>
								<td>Reply Cost</td>
								<td><input type="text" name="replycost" id="replycost" class="input required"  value="<%=cm.getLocalreplycost()%> "/>
