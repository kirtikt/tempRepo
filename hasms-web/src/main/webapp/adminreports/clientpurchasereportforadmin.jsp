...
<body>
		...
		<tr>
			...
			<td valign="top">
				...
				<table width="70%" align="center">
					<tr>
						<td><c:if test="${not empty requestScope.map}">
								<form action="/payless4sms/DownloadReportAPIByMap"
					...
					<tr>
						<td>
							<form action="/payless4sms/ClientPurchaseReportForAdmin" method="post">
								<!-- id="formid" name="form" onSubmit="return checkDayMonth();"> -->
								<table>
									<tr>
										<td>Select Client :</td>
										<td><select name="managerid" id="manageriddrop"
 ...
 %> <input type="hidden" name="managerid" value="<%=managerid%>" />
									...
									<tr>
										<td><input type="submit" value="View" id="View" /></td>
									</tr>
								</table>
							</form></td>
					</tr>
					<tr>
						<c:if test="${not empty requestScope.fromDate}">
							...
							<tr style="font-size: 14px">
								<td><b>Client : ${param.managername} &nbsp; &nbsp; &nbsp;
								Report from ${requestScope.fromDate} to
										${requestScope.toDate}</b>
								</td>
							</tr>
