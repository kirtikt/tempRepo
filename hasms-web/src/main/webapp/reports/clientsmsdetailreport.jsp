...
<table border="1px" cellpadding="0" cellspacing="0" width="100%">
	...
	<table border='1' id='flexme1' width='100%'>
		...
		List smsSet=new SmsManager().getSmsListForHolA(pkey);
			...
			boolean flag = false;
			out.print("<tr><th>destination</th><th>Status</th><th>SmsId</th><th>Message</th><tr>");
			...
			while (it.hasNext()) {
			   ...
			   if ((sms.getStatus().trim()).equals("11")){
				out.print("<tr><td>"
						+ sms.getDestination()
						+ "</td><td>" + hp.getClientStatusMessage(sms.getStatus(), hp.myTimeIn(sms.getDatetime()).toString())  + "</td><td><a href='/payless4sms/reports/getDetailSmsIdReport.jsp?smsid="+sms.getSmsid()+"'>" + sms.getSmsid() + "</td><td>"
						+ sms.getMessage() + "</td><tr>");
			   }
			   sms=null;
			}
