		...
		<tr>
			...
			<td valign="top">
				...
				<tr>
					...
					<tr>
						<td>
							<form action="/payless4sms/ClientCreditReport" method="post">
								...
								<table>
									...
									<tr>
										<td><input type="submit" value="View" id="getreport" />
										</td>
									</tr>
								</table>
							</form>
					...
					<tr>
						<c:if test="${not empty requestScope.fromDate}">
							...
							<tr style="font-size: 14px">
								<td><b>Credit Report from ${requestScope.fromDate} to
								...
								<tr>
									<td>
										<table border='1' id='flexme1' width='100%'>
											<tr>
												<th>Record</th>
												<c:forEach items="${oye.map}" var="outerMap"
