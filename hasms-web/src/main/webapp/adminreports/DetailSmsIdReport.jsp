...
<table border="1px" cellpadding="0" cellspacing="0" width="100%">
	...
	<table border='1' id='flexme1' width='100%'>
		...
		List<Sms> smsList= new SmsManager().getSmsList("smsid",request.getParameter("smsid"));
			...
			boolean flag = false;
			out.print("<tr><th>destination</th><th>source</th><th>Status</th><th>SmsId</th><tr>");
			...
			while (it.hasNext()) {
				...
				out.print("<tr><td>"
						...
						+ "</td><td>" + hp.getAdminStatusMessage(sms.getStatus(), sms.getSendinginterface().getKannelname(), hp.myTimeIn(sms.getDatetime()).toString()) + "</td>"
						+ "<td>" + sms.getSmsid() + "</td><td><tr>");
